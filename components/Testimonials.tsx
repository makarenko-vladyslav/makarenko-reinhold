        ...
        <div className="grid md:grid-cols-3 gap-8 mt-12">
          {data.items.map((item: any, i: number) => (
            ...
            >
              ...
              <p className="text-primary italic mb-8 relative z-10">"{item.text}"</p>
              
              <div className="flex items-center gap-4">
                <img src={`https://picsum.photos/seed/${item.name}/100/100`} alt={item.name} className="w-12 h-12 rounded-full object-cover" loading="lazy" />
                <div>
