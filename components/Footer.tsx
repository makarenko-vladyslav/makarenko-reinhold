        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><a href="#calculator" className="text-gray-400 hover:text-accent transition-colors">{t('nav.calculator')}</a></li>
              <li><a href="#reviews" className="text-gray-400 hover:text-accent transition-colors">{t('nav.reviews')}</a></li>
            </ul>
          </div>

          {/* Contact */}
          <div>
            <h4 className="text-white font-bold mb-6">{t('footer.contactTitle')}</h4>
