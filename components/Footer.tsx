      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-white/70 max-w-sm leading-relaxed mb-8">{t("footer.description")}</p>
            <div className="flex gap-4">
              <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center text-white/50 hover:bg-accent hover:text-white transition-colors cursor-pointer">
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/70">
              ...
              <li><a href={`tel:${t("contact.phone")}`} className="hover:text-accent transition-colors">{t("contact.phone")}</a></li>
              <li><a href={`mailto:${t("contact.email")}`} className="hover:text-accent transition-colors">{t("contact.email")}</a></li>
            </ul>
          </div>
