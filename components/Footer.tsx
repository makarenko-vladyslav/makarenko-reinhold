        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#services" className="text-white/60 hover:text-accent transition-colors">Flyttevask</a></li>
              <li><a href="#services" className="text-white/60 hover:text-accent transition-colors">Regelmessig vask</a></li>
              <li><a href="#services" className="text-white/60 hover:text-accent transition-colors">Kontorvask</a></li>
              <li><a href="#services" className="text-white/60 hover:text-accent transition-colors">Vindusvask</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#contact" className="text-white/60 hover:text-accent transition-colors">{t('nav.contact')}</a></li>
            </ul>
          </div>
