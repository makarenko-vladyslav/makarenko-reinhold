    ...
    <footer className="bg-primary text-white/70 py-16 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-2">
            <a href="#" className="flex items-center gap-3 mb-6 text-white">
              <svg className="w-8 h-8" viewBox="0 0 32 32">
                <rect width="32" height="32" rx="8" fill="hsl(183, 74%, 35%)" />
            ...
            <p className="max-w-sm mb-6">{f.description}</p>
          ...
          <div>
            <h4 className="text-white font-bold mb-6">{f.quickLinks}</h4>
          ...
          <div>
            <h4 className="text-white font-bold mb-6">{f.legal}</h4>
            <ul className="space-y-3">
        ...
        <div className="pt-8 border-t border-white/10 text-sm flex flex-col md:flex-row justify-between items-center gap-4">
          <p>&copy; {new Date().getFullYear()} Makarenko Reinhold. {f.rights}</p>
          <div className="flex gap-4">
            <span className="opacity-50">Org.nr: 932 841 932</span>
          </div>
        </div>
      </div>
    </footer>
